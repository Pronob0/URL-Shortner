...
<div class="breadcrumb-area">
    <h3 class="title text--white">@lang('Deactivated Links')</h3>
    <ul class="breadcrumb">
        <li>
...
<div class="dashborad--content">
    <div class="dashboard--content-item">
        ...
        <div class=" table--mobile-lg">
            ...
            <table class="table bg--body " id="link-table">
                ...
                <tbody id="link-table">
                    ...
                    <tr>
                        ...
                        <td data-label="Payment Method">
                            <div>
                               <a href="{{ $link->url }}" class="btn btn--primary btn-sm"> <i class="fas fa-link"></i> </a>
                               <a id="copy-user" href="javascript:;" class="btn btn--success btn-sm" data-value="{{ $link->alias }}"> <i class="fas fa-copy"></i> </a>
                            </div>
                        </td>
                        <td data-label="Rate">
                            <div>
                        ...
                        <td data-label="Payment Method">
                            <div>
                                ...
                                @else
                                ( {{ checkexpire($link->id) }} ) @lang('Days Left')
                                @endif
            ...
            <div class="card p-5">
                <h4 class="text-center">@lang('No Link Found here!')</h4>
            </div>
