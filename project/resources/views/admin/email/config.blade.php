      ...
      <div class="card mb-4">
         ...
         <div class="card-body">
            ...
            <form class="geniusform" action="{{ route('admin.gs.update') }}" method="POST" enctype="multipart/form-data">
               ...
               <div class="new-email" id="new-email">
              ...
              @if ($gs->is_smtp==1)
               ...
               <div class="form-group">
                  ...
                  <input type="text" class="input-field" placeholder="{{ __('Mail Encryption') }}" name="mail_encryption" value="{{ $gs->mail_encryption }}" >
               </div>
               <div class="form-group">
   ...
   $(document).ready(function() {
      $('.drop-change').on('click', function() {
        ...
        if(status==1){
         ...
         $('#new-email').removeClass('d-none');
        }
        if(status==0){
         $('#new-email').addClass('d-none');
        }
      });
   });
